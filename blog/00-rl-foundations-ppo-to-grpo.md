...
Four lines. (The ratio is computed in log-space and exponentiated as `exp(new - old)`, which is both numerically kinder and free, since you already have log-probs.)
